...
class OcTreeDrawer : MonoBehaviour
{
	...
	[SerializeField] bool drawOctMap2;
	...
	void Update()
	{
		...
		Vector3 size = drawOctMap2 ? octmap.octMap.CanvasSize : octmap.octMap.CanvasSize;
		OctVoxelChunk root = drawOctMap2 ? octmap.octMap.rootChunk : octmap.octMap.rootChunk;
		int level = drawOctMap2 ? octmap.octMap.levels : octmap.octMap.levels;
