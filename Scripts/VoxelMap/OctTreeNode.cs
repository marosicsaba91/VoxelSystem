...
namespace VoxelSystem
{
    ...
    public class OctTreeNode
    {
        ...
        public OctTreeNode(int value = defaultValue)
        {
            this.value = value;
        }
        ...
        public bool IsHomegenous => innerChunks == null;

        public bool IsEmpty => value == defaultValue;
        ...
        {
            if (innerChunks[0].innerChunks != null) return false;
