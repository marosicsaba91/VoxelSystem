...
{
	public class VoxelToolHandler_VoxelTypePicker : VoxelToolHandler
	{
		...
		{
			int paletteIndex = voxelEditor.SelectedVoxelTypeIndex;
		...
		{ 
			voxelEditor.SelectedVoxelTypeIndex = voxelEditor.Map.GetVoxel(index).GetVoxelTypeIndex();
		}
	}
}
