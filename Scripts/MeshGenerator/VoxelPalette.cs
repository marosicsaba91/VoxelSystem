...
namespace VoxelSystem
{
	...
	public class VoxelPalette : ScriptableObject, IPalette
	{
	...
	public abstract class UniversalVoxelBuilder : ScriptableObject, IPaletteItem
	{
		...
		internal void BeforeMeshGeneration(VoxelMap map, VoxelPalette palette, int voxelTypeIndex, bool quick) =>
			GetVoxelVersion(quick).BeforeMeshGeneration(map, palette, voxelTypeIndex);


		protected abstract void BeforeMeshGeneration(VoxelMap map, VoxelPalette palette, int voxelTypeIndex);
